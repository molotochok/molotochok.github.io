...
function MenuComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function MenuComponent_div_0_Template_div_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r5); const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](2); return _r1.open(); });
...
MenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: MenuComponent, selectors: [["app-menu"]], decls: 1, vars: 1, consts: [["class", "menu", 4, "ngIf"], [1, "menu"], ["settings", ""], [1, "menu-header"], ["src", "assets/images/menu/avatar.jpg", 1, "menu-logo"], [1, "menu-items"], [4, "ngFor", "ngForOf"], [1, "footer-parent"], [1, "menu-item", "app-mb-0", 3, "click"], ["src", "assets/images/menu/settings.svg", 1, "menu-item-img"], [1, "menu-item-title"], [1, "footer"], [1, "menu-item", 3, "routerLink", "ngClass"], [1, "menu-item-img", 3, "src"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
...
GalleryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: GalleryComponent, selectors: [["app-gallery"]], viewQuery: function GalleryComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { mediaList: "mediaList", spaceBetween: "spaceBetween" }, decls: 11, vars: 6, consts: [[1, "gallery"], [1, "gallery-content"], [1, "icon", "prev", 3, "ngStyle", "click"], [1, "media-list-container", 3, "ngStyle"], [1, "media-list", 3, "ngStyle"], [3, "ngClass", "ngStyle", 4, "ngFor", "ngForOf"], [1, "icon", 3, "ngStyle", "click"], [1, "gallery-dots"], ["class", "dot", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], ["imgModal", ""], [3, "ngClass", "ngStyle"], [3, "video", 4, "ngIf"], [3, "src", "ngStyle", "click", 4, "ngIf"], [3, "video"], [3, "src", "ngStyle", "click"], [1, "dot", 3, "ngClass", "click"], [1, "modal-header"], ["aria-label", "Close", 1, "close", 3, "click"], [1, "modal-body"], [3, "src"]], template: function GalleryComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
DasDemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DasDemoComponent, selectors: [["app-das-demo"]], viewQuery: function DasDemoComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 2, vars: 0, consts: [["modalContent", ""], [1, "das-demo"], [1, "modal-header"], [1, "title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["ngbAutofocus", "", 1, "unity-fullscreen", 3, "ngStyle", "click"], [1, "modal-body"], [1, "webgl-content"], ["id", "unityContainer", 1, "unity-container"]], template: function DasDemoComponent_Template(rf, ctx) { if (rf & 1) {
...
SelectComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SelectComponent, selectors: [["app-select"]], hostBindings: function SelectComponent_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { selectedOption: "selectedOption", options: "options", i18nSourcePath: "i18nSourcePath" }, outputs: { optionSelected: "optionSelected" }, decls: 4, vars: 3, consts: [[1, "select"], ["class", "selected-option", 3, "click", 4, "ngIf"], [1, "options", 3, "ngClass"], ["class", "option-wrapper", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "selected-option", 3, "click"], [3, "src"], [1, "arrow", 3, "ngStyle", "ngClass"], [1, "option-wrapper", 3, "ngClass", "click"], [1, "option"]], template: function SelectComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
